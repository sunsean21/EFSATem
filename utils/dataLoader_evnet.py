...
working_dir = "/home1/ssq/proj1/evnet/data"
event_dir = "/home1/ssq/proj1/evnet/data/event/Dataset_Training_Synthetic"
image_dir = "/home1/ssq/proj1/evnet/data/image/Dataset_Training_Synthetic"
...
def event_preprocess_RainVIDSS(patch_size, stride, seq_crop_len=7, seq_crop_stride=7, data_path=working_dir, if_sb=False, image_dir="/home1/ssq/proj1/evnet/data/image/dataset_RainVIDSS/", event_dir="/home1/ssq/proj1/evnet/data/event/RainVIDSS/train/rainy"):
    print('process training data')
...
class NTURainData(Dataset):
    def __init__(self, data_path=working_dir, if_event=False, data_name='NTURain'):
        ...
        target_path = os.path.join(self.data_path, 'train_target_{}_s7_128.h5'.format(self.data_name))
    ...
    def __getitem__(self, index):
        ...
        target_path = os.path.join(self.data_path, 'train_target_{}_s7_128.h5'.format(self.data_name))
        input_path = os.path.join(self.data_path, 'train_input_{}_s7_128.h5'.format(self.data_name))
        ...
        if self.if_event:
            event_path = os.path.join(self.data_path, 'train_event_{}_s7_128.h5'.format(self.data_name))
